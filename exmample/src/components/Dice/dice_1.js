...
export default class Dice_1 extends Component {
    ...
    render() {
       ...
       if(this.props.ok){
        return (
            <View>
              <Animated.Image source={this.props.id==='d0'?d0:this.state.source_1}  style={[{...this.props.style},squareAnimation,{top:270,left:45}]} {...this.panResponder.panHandlers}/>
                <Animated.Image source={this.props.id==='d0'?d0:this.state.source_2} style={[{...this.props.style},squareAnimation,{top:270,left:95}]}{...this.panResponder.panHandlers}/>
            </View>
         );}
         else {
             return null;
